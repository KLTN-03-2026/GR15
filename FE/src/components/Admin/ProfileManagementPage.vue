    ...
    <div v-else class="divide-y divide-slate-100 dark:divide-slate-800">
      ...
      >
        <div class="min-w-0">
          ...
          <p class="mt-3 max-h-28 overflow-y-auto pr-1 text-sm leading-7 text-slate-600 dark:text-slate-300 whitespace-pre-line">
        ...
        <div class="rounded-xl border border-slate-200 bg-slate-50 px-4 py-3 dark:border-slate-700 dark:bg-slate-800">
          ...
          <div class="mt-3 space-y-2 text-sm text-slate-600 dark:text-slate-300">
            ...
            <p>Kinh nghiệm: <strong class="text-slate-900 dark:text-white">{{ formatExperienceYears(profile.kinh_nghiem_nam) }}</strong></p>
          </div>
        </div>
      ...
      <div v-else-if="selectedProfile" class="flex-1 space-y-5 overflow-y-auto px-6 py-6">
        <div class="grid grid-cols-1 gap-4 md:grid-cols-3">
          ...
          <div class="rounded-2xl bg-slate-50 px-4 py-4 dark:bg-slate-800">
            ...
            <p class="mt-2 text-sm font-semibold text-slate-900 dark:text-white">{{ formatExperienceYears(selectedProfile.kinh_nghiem_nam) }}</p>
          </div>
          <div class="rounded-2xl bg-slate-50 px-4 py-4 dark:bg-slate-800">

    ...
    <div v-else class="divide-y divide-slate-100 dark:divide-slate-800">
      ...
      >
        <div class="min-w-0">
          ...
          <p class="mt-3 max-h-28 overflow-y-auto pr-1 text-sm leading-7 text-slate-500 dark:text-slate-400 whitespace-pre-line">
    ...
    <div class="mx-auto w-full max-w-4xl rounded-[28px] border border-slate-200 bg-white shadow-2xl dark:border-slate-800 dark:bg-slate-900">
      ...
      <div class="max-h-[calc(100vh-12rem)] overflow-y-auto px-6 py-6">
        ...
        <div class="mt-6 rounded-3xl border border-slate-200 p-5 dark:border-slate-800">
          ...
          <div class="mt-4 max-h-56 overflow-y-auto rounded-2xl bg-slate-50 p-4 pr-5 text-sm leading-7 text-slate-600 dark:bg-slate-800/60 dark:text-slate-300 whitespace-pre-line">
        ...
        <div class="mt-6 rounded-3xl border border-slate-200 p-5 dark:border-slate-800">
          ...
          <div class="mt-4 grid grid-cols-1 gap-4 md:grid-cols-2">
            <div class="rounded-2xl bg-slate-50 p-4 text-sm leading-7 text-slate-600 dark:bg-slate-800/60 dark:text-slate-300">
              ...
              <p class="mt-2 max-h-40 overflow-y-auto pr-1 whitespace-pre-line">{{ selectedApplication.ket_qua_phong_van || 'Chưa cập nhật' }}</p>
            </div>
            <div class="rounded-2xl bg-slate-50 p-4 text-sm leading-7 text-slate-600 dark:bg-slate-800/60 dark:text-slate-300">
              <p class="text-[11px] font-semibold uppercase tracking-[0.2em] text-slate-400">Ghi chú</p>
              <p class="mt-2 max-h-40 overflow-y-auto pr-1 whitespace-pre-line">{{ selectedApplication.ghi_chu || 'Chưa có ghi chú từ nhà tuyển dụng.' }}</p>
            </div>
          </div>
        </div>
      </div>

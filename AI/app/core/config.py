...
class Settings:
    ...
    cv_builder_writing_provider: str = os.getenv("CV_BUILDER_WRITING_PROVIDER", "gemini")
    match_explanation_provider: str = os.getenv("MATCH_EXPLANATION_PROVIDER", "gemini")
    career_report_max_tokens: int = int(os.getenv("CAREER_REPORT_MAX_TOKENS", "900"))
    cover_letter_max_tokens: int = int(os.getenv("COVER_LETTER_MAX_TOKENS", "750"))
    cv_builder_writing_max_tokens: int = int(os.getenv("CV_BUILDER_WRITING_MAX_TOKENS", "650"))
    match_explanation_max_tokens: int = int(os.getenv("MATCH_EXPLANATION_MAX_TOKENS", "700"))
